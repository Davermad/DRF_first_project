...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Daniel\Desktop\projects python\DRF first project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Daniel\Desktop\projects python\DRF first project\venv\Scripts\deactivate.nu'
